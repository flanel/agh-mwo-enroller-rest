...
public class ParticipantRestController {
	...
	public ResponseEntity<?> getMeeting(@PathVariable("id") String login) {
	 ...
	 public ResponseEntity<?> registerParticipant(@RequestBody Participant participant) {
		 ...
		 Participant tmpParticipant = participantService.findByLogin(participant.getLogin());
	 ...
	 public ResponseEntity<?> editParticipant(@PathVariable("id") String login, @RequestBody String password) {
